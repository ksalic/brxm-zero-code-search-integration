...
@HippoEssentialsGenerated(internalName = "searchdemo:contentdocument")
@Node(jcrType = "searchdemo:contentdocument")
public class ContentDocument extends BaseDocument {
    @HippoEssentialsGenerated(internalName = "searchdemo:introduction")
    public String getIntroduction() {
        return getProperty("searchdemo:introduction");
    }
    ...
    public Calendar getPublicationDate() {
        return getProperty("searchdemo:publicationdate");
    }
}
