...
After your project is set up, access the CMS at <http://localhost:8080/cms> and the site at <http://localhost:8080/searchdemo>.
Logs are located in target/tomcat9x/logs

Running Locally Search Service
==============================

Inside the search-service directory

    mvn clean install
    mvn spring-boot:run

The search service will do an intial document index in elastic search during startup and will listen to publish and depublish events
...
as org.example/searchdemo:0.1.0-SNAPSHOT
